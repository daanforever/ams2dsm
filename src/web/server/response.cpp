...
namespace Web::Server
{
    ...
    {
        return original.has_header( key );
    };
    ...
    void Response::render( const std::string& path, const inja::json& data )
    {
        inja::Environment env{ "./web/" };
        set_content( env.render_file( path, data ), "text/html" );
    }
